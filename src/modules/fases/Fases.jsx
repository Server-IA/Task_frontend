...
export default function Fases() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white transition-colors">Gestión de Fases</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-2 transition-colors">Administra las fases del sistema</p>
      </div>
